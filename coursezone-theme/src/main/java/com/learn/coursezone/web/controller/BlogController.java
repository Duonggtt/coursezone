...
public class BlogController {
    ...
    public BlogController(WebPostControllerService postControllerService,
                          WebEClassControllerService eclassControllerService,
                          WebCommonValidator webCommonValidator,
                          WebProductCurrencyService productCurrencyService) {
    ...
    @DoGet("/blogs")
    public View getBlogs(HttpServletRequest request, @UserId Long userId,
                         @PathVariable String code, @RequestParam("keyword") String keyword,
        ...
        PaginationModel<WebEClassResponse> pagination
            = this.eclassControllerService
            .getPublicClasses(userId, keyword, nextPageToken, prevPageToken,
                lastPage, limit, defaultCurrency.getId(), defaultCurrency.getFormat());
        PaginationModel<WebPostContentResponse> posts
            = this.postControllerService
            .getPostContentPagination(filter, language, nextPageToken,
    ...
    public View getDetail(HttpServletRequest request, @PathVariable String slug,
                          @UserId Long userId, @RequestParam("keyword") String keyword,
                          @RequestParam("nextPageToken") String nextPageToken,
                          @RequestParam("prevPageToken") String prevPageToken,
                          @RequestParam("lastPage") boolean lastPage,
        ...
        PaginationModel<WebEClassResponse> pagination
            = this.eclassControllerService
            .getPublicClasses(userId, keyword, nextPageToken, prevPageToken, lastPage, limit,
        ...
        PaginationModel<WebPostContentResponse> posts
            = this.postControllerService
            .getPostContentPagination(filter, language, nextPageToken, prevPageToken, lastPage, 5);
        return View.builder()
